...
<div
      ...
      >
        ...
        <span className="font-medium text-[20px] text-[#ffffff] pt-2 pb-2 flex flex-col justify-center w-full text-center items-center space-x-1">
          ...
          <img src='/bulllogo2.png' alt='dscfd' className='w-[18px]'/>

          <span className="text-accent pr-[6px]">+{formatNumber(pointsEarned)} $BDOG </span> CLAIMED
              </span>
        </span>
...
<img src='/bulllogo2.png' alt='sdfd' className='w-[8px]'/>
</div>
