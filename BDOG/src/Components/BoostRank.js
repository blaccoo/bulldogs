...
<img src='/BDOGlogo2.png' alt='sdfd' className='w-[15px]'/>

          <span className="text-accent">+{selectedPower.capacity} $BDOG</span>
              </span>
          <span>Your Purchase of {selectedPower.xx} $BDOG is successful</span>
        </span>
        <p className="pb-6 text-[15px] w-full text-center">
          Perform more activities or buy more $BDOG to stay ahead and claim listing giveaway bonues!😎
        </p>
      </div>
      );
    ...
    <button
        onClick={() => setOpenBoost(true)}
         className='bg-btn4 h-[45px] flex justify-center items-center space-x-2 font-medium w-full rounded-[8px]'>
                <img src='/BDOGlogo2.png' alt='fdfvds' className='w-[14px]'/>
                <span>
                    Boost your Rank
                    </span>
            </button>
...
<img src='/BDOGlogo2.png' alt='sdfd' className='w-[70px]'/>
...
<img src='/BDOGlogo2.png' alt='sdfd' className='w-[7px]'/>
</span>
</span>
...
<img src='/BDOGlogo2.png' alt='sdfd' className='w-[70px]'/>
                    ...
                    <p className="pb-6 text-primary text-[14px] px-4 text-center">
                      Get {selectedPower.capacity} $BDOG and boost your earnings and ranks!
                    </p>
